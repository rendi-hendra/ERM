...
<h1 class="text-2xl font-bold mb-2">Master Asuransi</h1>
<p class="text-gray-500 mb-6">Kelola data asuransi kesehatan</p>

<div class="flex justify-between items-center mb-4">
    <form method="get" action="<?= base_url('asuransi') ?>" class="inline-flex w-1/2">
    ...
    <a href="<?= base_url('/asuransi/create') ?>" class="bg-gray-900 text-white px-4 py-2 rounded-lg hover:bg-gray-700">
    ...
    <table class="min-w-full text-sm">
        <thead class="bg-gray-100 text-gray-700">
            <tr>
                ...
                <th class="px-4 py-3 text-left font-semibold">No. Kontak</th>
            ...
            <?php else: ?>
                <?php foreach ($asuransi as $a): ?>
                    <tr>
                        ...
                        <td class="px-4 py-3"><?= esc($a['no_kontak']) ?></td>
                        <td class="px-4 py-3"><?= esc($a['alamat']) ?></td>
                        <td class="px-4 py-3 text-center">
                            <a href="<?= base_url('/asuransi/edit/' . $a['id']) ?>" class="text-blue-600 hover:bg-gray-200 p-2 rounded-lg btnEdit">
                                <i class="bi bi-pencil-square text-lg"></i>
                            </a>

                            <a href="#"
                                class="text-red-600 hover:bg-gray-200 p-2 rounded-lg ml-3 btn-delete"
                                data-url="<?= base_url('/asuransi/delete/' . $a['id']) ?>">
